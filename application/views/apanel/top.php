<meta charset="utf-8">
<link href="<?= base_url('css/admin.css'); ?>" rel="stylesheet" rev="stylesheet" />
<link href="<?= base_url('css/tailwind.min.css'); ?>" rel="stylesheet" rev="stylesheet" />
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                    type="button" <a href="#" class="flex ms-2 md:me-24">
                    <img src="<?= base_url('images/archeleogy-logo.png') ?>" class="w-80 mx-2" alt="FlowBite Logo" />
                    </a>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-sm whitespace-nowrap dark:text-white"> Admin
                        system</span>
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="<?= base_url('apanel/category'); ?>"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap"> Book Category </span>
            ...
            <li>
                <a href="<?= base_url('apanel/news_category'); ?>"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap"> News Category </span>
            ...
            <li>
                <a href="<?= base_url('apanel/product'); ?>"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap">Book Бүтээгдэхүүн </span>
            ...
            <li>
                <a href="<?= base_url('apanel/test'); ?>"
                    ...
                    <span class="flex-1 ml-2 whitespace-nowrap"> Тест PDF service </span>

                </a>
            </li>
            <li>
                <a href="<?= base_url('apanel/home/logout'); ?>"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
