...
<div class="container">
    <div id="body" class="pt-5 ml-72 mt-20 w-full">
        ...
        <table cellpadding="5" border="0" align="left" class="table-border-none" class="text-center mx-auto">
            ...
            <tr class='tablebody'>
                ...
                <td><input type="text" name="title"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?php if (isset($news[0]->title)) {
                            echo $news[0]->title;
                        }
                        ; ?>"></td>
            </tr>
                    ...
                    <select name="menuid"
                        ...
                        for ($i = 0; $i < count($menulist); $i++) {
                            if ($menulist[$i]->parentid == 0) { ?>
                                <option value="<?= $menulist[$i]->id; ?>" <?php if (isset($news[0]->menuid)) {
                                      if ($news[0]->menuid == $menulist[$i]->id) {
                                          echo "selected";
                                      }
                                  } ?>>
                                    <?= $menulist[$i]->menuname; ?>
                                ...
                                for ($j = 0; $j < count($menulist); $j++) {
                                    if ($menulist[$i]->id == $menulist[$j]->parentid) { ?>
                                        <option value="<?= $menulist[$j]->id; ?>" <?php if (isset($news[0]->menuid)) {
                                              if ($news[0]->menuid == $menulist[$j]->id) {
                                                  echo "selected";
                                              }
                                          } ?>>
                                        ...
                                        for ($k = 0; $k < count($menulist); $k++) {
                                            if ($menulist[$j]->id == $menulist[$k]->parentid) { ?>
                                                <option value="<?= $menulist[$k]->id; ?>" <?php if (isset($news[0]->menuid)) {
                                                      if ($news[0]->menuid == $menulist[$k]->id) {
                                                          echo "selected";
                                                      }
                                                  } ?>>
            ...
            <tr class='tablebody'>
                ...
                <td>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        name="description"><?php if (isset($news[0]->description)) {
            ...
            <tr class='tablebody'>
                ...
                <td>
                    <textarea name="info"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php if (isset($news[0]->info)) {
                            echo $news[0]->info;
                        } ?></textarea>
                    <script type="text/javascript">
                        CKEDITOR.replace('info', {
                            "extraPlugins": 'imagebrowser,justify,font',
                            "imageBrowser_listUrl": "<?= base_url('admin/browserfile'); ?>",
            ...
            <tr class='tablebody'>
                ...
                <td>
                    <select name="highlight" id="highlight"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option value="0" <?php if (isset($news[0]->highlight)) {
                            if ($news[0]->highlight == 0) {
                                echo "selected";
                            }
                        } ?>>
                            Үгүй
                        </option>
                        <option value="1" <?php if (isset($news[0]->highlight)) {
                            if ($news[0]->highlight == 1) {
                                echo "selected";
                            }
                        } ?>>
                            Онцлох</option>
        ...
        <input type="hidden" name="newsid" value="<?php if (isset($news[0]->id)) {
            echo $news[0]->id;
        }
        ; ?>">
        <input type="hidden" name="newspicurl" id="newspicurl" value="<?php if (isset($news[0]->picurl)) {
            echo $news[0]->picurl;
        }
        ; ?>" />
        <input type="hidden" name="newssmallpicurl" id="newssmallpicurl" value="<?php if (isset($news[0]->small_picurl)) {
            echo $news[0]->small_picurl;
        }
        ; ?>" />
        </form>
    </div>
