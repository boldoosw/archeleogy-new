...
<div class="container mt-5">
    <div id="body" class="pt-5 ml-72 mt-20 w-full">
        <?php echo form_open_multipart(base_url("apanel/news_category/save")); ?>
        <table cellpadding="5" border="0" class="table-border-none">
                ...
                <td>
                    <select name="category_type_id"
                        ...
                        for ($i = 0; $i < count($categorytype); $i++) { ?>
                            ...
                            <option value="<?= $categorytype[$i]->id; ?>" <?php if (isset($category[0]->category_type_id)) {
                                if ($category[0]->category_type_id == $categorytype[$i]->id) {
                                    echo "selected";
                                }
                            } ?>>
            ...
            <tr class='tablebody'>
                ...
                <td><input type="text" name="title"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="<?php if (isset($category[0]->title)) {
            ...
            <tr class='tablebody'>
                ...
                <td>
                    <textarea
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        name="description"><?php if (isset($category[0]->description)) {
            ...
            <tr class='tablebody'>
                ...
                <td>
                    <textarea name="info"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php if (isset($category[0]->info)) {
                            echo $category[0]->info;
                        } ?></textarea>
            ...
            <!-- <tr class='tablebody'>
                ...
                <td>
                    <select name="highlight" id="highlight"
                        ...
                        <option value="1"
                            <?php if (isset($category[0]->highlight)) {
                                if ($category[0]->highlight == 1) {
                                    echo "selected";
                                }
                            } ?>>
                            Онцлох</option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?= base_url("apanel/news_category"); ?>">
                        <button type="button"
        ...
        <input type="hidden" name="categoryid" value="<?php if (isset($category[0]->id)) {
            echo $category[0]->id;
        }
        ; ?>">
        <input type="hidden" name="categorypicurl" id="categorypicurl"
            value="<?php if (isset($category[0]->picurl)) {
                echo $category[0]->picurl;
            }
            ; ?>" />
        <input type="hidden" name="categorysmallpicurl" id="categorysmallpicurl"
            value="<?php if (isset($category[0]->small_picurl)) {
                echo $category[0]->small_picurl;
            }
            ; ?>" />
        </form>
    </div>
