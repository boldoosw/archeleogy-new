...
<div class="container" style="margin-top:60px;margin-left:280px">
    <div class="row">
        <div class="col-lg-4 col-lg-offset-4">
            ...
            <div class="form-group">
                ...
                echo form_input('language_name', set_value('language_name'), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="form-group">
                ...
                echo form_input('language_directory', set_value('language_directory'), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_input('language_code', set_value('language_code'), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
            ...
            <?php echo form_submit('submit', 'Add language', 'class="btn btn-primary btn-lg btn-block"'); ?>
